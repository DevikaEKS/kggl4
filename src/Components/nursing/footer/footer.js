...
import kgisllogo from '../Assest/kgisl-logo.webp';
             ...
             <div className="container-fluid bgcolor text-white " id="footer">
                <div className="row">
                    <div className="col-lg-2 pt-5 ms-4 mt-4  ">
                        ...
                        <p> <Sclink to="service" spy={true} smooth={true} duration={500} className="nav-link active text-white" aria-current="page">Our Process</Sclink> </p>
