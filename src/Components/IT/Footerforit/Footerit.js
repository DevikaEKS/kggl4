...
import kgisllogo from '../Assetit/kgisl-logo.webp';
              ...
              <div className="container-fluid bgcolor text-white" id="footerforit">
                <div className="row">
                    ...
                    <div className="col-lg-3  me-3 mt-5">
                        ...
                        <a href="https://www.kgisl.com/"><img src={kgisllogo} alt="KG Genius Lab's subdivision of KGiSL" title="KG Genius Labs" className="col-lg-6 col-6 "/></a>
